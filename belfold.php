...
<div class="wrapper row2">
  <div id="container" class="clear"> 
    ...
    <section id="content"> 
      ...
      <section>
        <h1>Belföldi utazásaink</h1>
       <div id="buttonHolder">
          <a href="belfold.php?sort=bycost" class="button">Ár szerint növekvő</a>
          <a href="belfold.php?sort=bystartdate" class="button">Dátum szerint növekvő</a>
       </div>
        <table class = "table">
          <tbody>
        <?php
